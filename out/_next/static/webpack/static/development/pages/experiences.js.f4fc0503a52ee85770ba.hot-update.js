...
})(["display:grid;grid-template-columns:3fr 1fr;margin-top:10px;padding:10px;background:green;border-radius:4px;p{margin:0;font-family:'QuicksandBold';:nth-child(2){text-align:right;}}@media ", "{grid-template-columns:1fr;grid-auto-rows:minmax(10px,auto);p{:nth-child(1){order:2;}:nth-child(2){order:1;}}}"], device.mobile);
...
//# sourceMappingURL=experiences.js.f4fc0503a52ee85770ba.hot-update.js.map