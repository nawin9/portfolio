...
})(["display:grid;grid-template-columns:3fr 1fr;margin-top:10px;padding:10px;background:", " p{margin:0;font-family:'QuicksandBold';:nth-child(1){}:nth-child(2){text-align:right;}}@media ", "{grid-template-columns:1fr;grid-auto-rows:minmax(10px,auto);p{:nth-child(1){order:2;}:nth-child(2){order:1;}}}"], color.primary, device.mobile);
...
//# sourceMappingURL=experiences.js.be28176e316a77864619.hot-update.js.map