...
})(["display:grid;grid-template-columns:3fr 1fr;margin-top:10px;background:green;p{margin:0;:nth-child(1){background:red;}:nth-child(2){background:blue;text-align:right;}}@media ", "{grid-template-columns:1fr;grid-auto-rows:minmax(10px,auto);p{:nth-child(1){order:2;}:nth-child(2){order:1;}}}"], device.mobile);
...
//# sourceMappingURL=experiences.js.e3b30836db10ca3c77e8.hot-update.js.map