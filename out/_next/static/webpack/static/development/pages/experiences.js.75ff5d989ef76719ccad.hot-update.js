...
})(["display:grid;grid-template-columns:3fr 1fr;margin-top:10px;background:green;p{:nth-child(1){background:'red'}:nth-child(2){background:'blue',textAlign:'right',}}"]);
...
//# sourceMappingURL=experiences.js.75ff5d989ef76719ccad.hot-update.js.map